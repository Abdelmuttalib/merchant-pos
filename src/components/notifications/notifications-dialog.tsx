...
export function NotificationsDialog () {
  ...
  return (
    <>
      ...
      >
        <div className='-mx-6 py-7 pb-[27px] border-b flex items-center'>
          <div className='px-6'>
            <Typography as='p' variant='sm/regular' className='text-foreground-lighter'>
            Recent activity from your account will appear here.{' '}
            </Typography>
          </div>
          {/* <NotificationsTabs /> */}
        </div>
